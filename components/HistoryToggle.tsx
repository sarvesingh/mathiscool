    ...
    <>
      <div className="flex justify-end px-4 pt-3">
        <button
          ...
          className="flex items-center gap-1 rounded-full border border-border px-2.5 py-1 text-xs font-medium text-muted transition-colors hover:text-foreground hover:bg-muted-light md:gap-1.5 md:px-3 md:py-1.5 md:text-sm"
        >
          History
