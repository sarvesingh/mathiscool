...
export const mathcountsStateQuestions: Question[] = [
  ...
  },
  {
    ...
    sectionId: "mc-sprint",
    gradeLevel: "7-8",
    questionText: "What is the remainder when 337 is divided by 5?",
    correctAnswer: "2",
    answerType: "integer",
    explanation: [
      { label: "Divide", content: "337 \u00F7 5 = 67 remainder 2." },
    ],
    tags: ["number theory"],
    difficulty: "easy",
  },
  ...
  },
  {
    ...
    sectionId: "mc-sprint",
    gradeLevel: "7-8",
    questionText: "If (x\u2078/x\u00B3) = x\u207F, what is the value of n for x > 1?",
    correctAnswer: "5",
    answerType: "integer",
    explanation: [
      { label: "Simplify", content: "x\u2078/x\u00B3 = x\u2078\u207B\u00B3 = x\u2075. So n = 5." },
    ],
  ...
  },
  {
    ...
    sectionId: "mc-sprint",
    gradeLevel: "7-8",
    questionText: "What is the largest prime factor of 3⁹ + 9³?",
    correctAnswer: "7",
    answerType: "integer",
    explanation: [
    ...
    explanation: [
      {
        ...
        content: "Digit sum can be 1, 4, 9, or 16 (perfect squares up to max digit sum 18). Count all integers with these digit sums.",
      },
      { label: "Count", content: "Digit sum 1: 1, 10, 100 \u2192 3. Digit sum 4: 4, 13, 22, 31, 40 \u2192 5. Digit sum 9: 9, 18, 27, 36, 45, 54, 63, 72, 81, 90 \u2192 10. Digit sum 16: 79, 88, 97 \u2192 3. Total = 3 + 5 + 10 + 3 = 21." },
    ],
